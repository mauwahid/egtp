...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
        ...
        <td height="30" align="left" bgcolor="#D50000"><strong class="csaf">Detail Agenda</strong></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td height="219" align="left" valign="top" background="<?php echo base_url() ?>assets/images/2014-05-27_110304.png"><table width="500" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <p> <?php echo $agenda_detail->topic ?> </p>
                        <p><?php echo $agenda_detail->place ?> , <?php echo $agenda_detail->start_date ?> - <?php echo $agenda_detail->finish_date ?> <?php echo $agenda_detail->time ?></p>

                        <p><?php echo $agenda_detail->description ?></p>
                    </td>
