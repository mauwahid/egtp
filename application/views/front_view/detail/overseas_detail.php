...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
        ...
        <td height="40" align="left" bgcolor="#D50000"><strong class="csaf">VIEW OVERSEAS NEWS</strong></td>
    </tr>
    <tr>
        <td align="center" bgcolor="#FFFFFF">&nbsp;</td>
        <td height="25" align="left" bgcolor="#FFFFFF"><table width="500" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="32"><strong class="up">CONTENT WEB <span class="csa">&gt; Overseas News &gt; View Overseas News</span></strong></td>
                </tr>
            </table></td>
    </tr>
    <tr>
        ...
        <td height="219" align="left" valign="top" background="<?php echo base_url() ?>assets/images/2014-05-27_110304.png"><table width="548" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="29" colspan="3"><label>
                            <input name="title" type="text" id="title" value="<?php echo $overseas_detail->title; ?>" size="50" readonly="readonly" />
                        </label></td>
                </tr>
                <tr>
                    <td width="145" height="30"><input name="category" type="text" id="category" value="<?php echo $overseas_detail->status; ?>" size="20" readonly="readonly" /></td>
                    <td width="210"><input name="publisher" type="text" id="publisher" value="<?php echo $overseas_detail->publisher; ?>" size="30" readonly="readonly" /></td>
                    <td width="193"><input name="status" type="text" id="status" value="<?php echo $overseas_detail->status; ?>" size="20" readonly="readonly" /></td>
                </tr>
                <tr>
                    <td height="128" colspan="3" align="center"><label>
                            <textarea name="desc" id="desc" cols="80" rows="10"><?php echo $overseas_detail->description; ?></textarea>
                        </label></td>
                </tr>
            </table></td>
    </tr>
