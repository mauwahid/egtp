...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
        ...
        <td height="40" align="left" bgcolor="#D50000"><strong class="csaf">VIEW GTP HOT NEWS</strong></td>
    </tr>
    <tr>
        <td align="center" bgcolor="#FFFFFF">&nbsp;</td>
        <td height="25" align="left" bgcolor="#FFFFFF"><table width="500" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="32"><strong class="up">CONTENT WEB <span class="csa">&gt; GTP Hot News &gt; View GTP Hot News</span></strong></td>
                </tr>
            </table></td>
    </tr>
    <tr>
